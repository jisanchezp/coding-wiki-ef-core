...
namespace CodingWiki.DataAccess.Migrations
{
    ...
    [Migration("20241003192955_AddFluentManyToManyRelationshipBooksAuthors")]
    partial class AddFluentManyToManyRelationshipBooksAuthors
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FluentAuthorFluentBook", b =>
                {
                    b.HasOne("CodingWiki.Model.Models.FluentAuthor", null)
                        .WithMany()
                        .HasForeignKey("AuthorsAuthor_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CodingWiki.Model.Models.FluentBook", null)
                        .WithMany()
